...
const BOXES = [
  { id: 'cat-no-claim', title: 'Status: No Claim', start: 0.00, end: 0.20, body: body_no_claim, isSticky: true, color: '#1D2CF3' },
  { id: 'cat-inconclusive', title: 'Status: Inconclusive', start: 0.20, end: 0.70, body: body_inconclusive, isSticky: true, color: '#898989' },
  { id: 'cat-pending', title: 'Status: Pending', start: 0.70, end: 1.00, body: body_pending, isSticky: true, color: '#B10000' },
  { id: 'final', title: 'Our Findings', start: 1.00, end: 1.08, body: body_final, isSticky: true, highContrast: true, color: '#fff' },
]
      ...
      {BOXES.map((box, idx) => (
        ...
        >
          <div style={{
            position: 'sticky',
            top: '120px',
            background: box.color || '#1D2CF3',
            color: (box.highContrast || box.darkText) ? '#000' : '#fff',
            border: box.highContrast ? '2px solid #1D2CF3' : 'none',
            padding: '20px 22px',
            fontFamily: "'ABeeZee', sans-serif",
            boxShadow: (box.highContrast || box.darkText) ? '0 4px 20px rgba(0,0,0,0.1)' : 'none',
          }}>
